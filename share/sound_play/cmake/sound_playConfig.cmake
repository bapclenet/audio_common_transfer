...
if("FALSE" STREQUAL "TRUE")
  set(sound_play_SOURCE_PREFIX /tmp/buildd/ros-hydro-sound-play-0.2.6-0raring-20140304-0057)
  set(sound_play_DEVEL_PREFIX /tmp/buildd/ros-hydro-sound-play-0.2.6-0raring-20140304-0057/obj-x86_64-linux-gnu/devel)
  ...
  set(sound_play_INSTALL_PREFIX /opt/ros/hydro)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'sound_play' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Austin Hendrix <ahendrix@willowgarage.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'sound_play' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Austin Hendrix <ahendrix@willowgarage.com>' to fix it.")
    endif()
